# -*- test-case-name: buildbot.broken_test.test_steps -*-
...
class Steps(unittest.TestCase):
    ...
    def test_addLog(self):
        s = makeBuildStep("runs.test_steps.Steps.test_addLog")
        l = s.addLog("newlog")
...
from buildbot.broken_test.runs.test_steps import VersionCheckingStep
from buildbot.buildslave import BuildSlave
