# -*- test-case-name: buildbot.broken_test.unit.test_config -*-
...
"""
from buildbot.broken_test.unit.test_config import MyTarget
c['status'] = [MyTarget('a')]
"""

targetCfg2 = startableEmptyCfg + \
"""
from buildbot.broken_test.unit.test_config import MySlowTarget
