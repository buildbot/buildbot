# -*- test-case-name: buildbot.broken_test.test_twisted -*-
...
class Counter(unittest.TestCase):
    ...
    def testCounter(self):
        ...
        add("bogus line\n")
        self.failUnlessEqual(self.progress, (None,None))
        add("buildbot.broken_test.test_config.ConfigTest.testBots ... [OK]\n")
        self.failUnlessEqual(self.progress, ("tests", 1))
        add("buildbot.broken_test.test_config.ConfigTest.tes")
        self.failUnlessEqual(self.progress, ("tests", 1))
        add("tBuilders ... [OK]\n")
        self.failUnlessEqual(self.progress, ("tests", 2))
        # confirm alternative delimiters work too.. ptys seem to emit
        # something different
        add("buildbot.broken_test.test_config.ConfigTest.testIRC ... [OK]\r\n")
        self.failUnlessEqual(self.progress, ("tests", 3))
        add("===============================================================================\n")
        self.failUnlessEqual(self.progress, ("tests", 3))
        add("buildbot.broken_test.test_config.IOnlyLookLikeA.testLine ... [OK]\n")
        self.failUnlessEqual(self.progress, ("tests", 3))
