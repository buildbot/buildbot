...
zsh/_buildworker: zsh tab-completion file for 'buildworker' command. Put it in
                 one of the directories appearing in $fpath to enable
                 tab-completion in zsh.

bash/buildworker: bash tab-completion file for 'buildworker' command. Source this
