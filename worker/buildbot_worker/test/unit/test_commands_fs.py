...
class TestRemoveDirectory(CommandTestMixin, unittest.TestCase):
    ...
    async def test_simple_real(self):
    ...
    async def test_simple_posix(self):
    ...
    async def test_simple_exception_real(self):
    ...
    async def test_multiple_dirs_real(self):
    ...
    @skipUnlessPlatformIs('posix')
    async def test_multiple_dirs_posix(self):
    ...
    @skipUnlessPlatformIs('posix')
    async def test_rm_after_chmod(self):
    ...
    @skipUnlessPlatformIs('posix')
    async def test_rm_after_failed(self):
        dir = os.path.join(self.basedir, 'remove')
        self.make_command(fs.RemoveDirectory, {'paths': [dir]}, True)
...
class TestMakeDirectory(CommandTestMixin, unittest.TestCase):
    ...
    async def test_error_existing_file(self):
...
class TestStatFile(CommandTestMixin, unittest.TestCase):
    ...
    async def test_file_workdir(self):
