...
class BBService(win32serviceutil.ServiceFramework):
    ...
    def SvcDoRun(self):
        ...
        while child_infos:
            ...
            rc = win32event.WaitForMultipleObjects(handles, 0, win32event.INFINITE)  # bWaitAll
            ...
            self.warning(
                "BuildBot for directory {0!r} terminated with "
    ...
    def createProcess(self, cmd):
        ...
        info = win32process.CreateProcess(
            None, cmd, None, None, True, create_flags, None, None, si
        )
