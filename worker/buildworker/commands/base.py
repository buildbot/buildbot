...
from buildworker import runprocess
from buildworker import util
from buildworker.commands import utils
from buildworker.exceptions import AbandonChain
from buildworker.interfaces import IWorkerCommand
...
#  >= 2.13: WorkerFileUploadCommand supports option 'keepstamp'
...
class SourceBaseCommand(Command):
    ...
    def setup(self, args):
        ...
        # command output will be in whatever the buildworker's native language
        # has been set to.
