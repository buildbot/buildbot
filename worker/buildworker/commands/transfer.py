...
from buildworker.commands.base import Command
...
class WorkerFileUploadCommand(TransferCommand):
    ...
    Arguments:
        ...
        - ['writer']:    RemoteReference to a buildworker.protocols.base.FileWriterProxy object
...
class WorkerFileDownloadCommand(TransferCommand):
    ...
    Arguments:
        ...
        - ['reader']:    RemoteReference to a buildworker.protocols.base.FileReaderProxy object
        - ['maxsize']:   max size (in bytes) of file to write
        - ['blocksize']: max size for each data block
    ...
    def start(self):
        ...
        try:
            ...
            if self.mode is not None:
                ...
                # will have the buildworker's default (umask) mode before we
                # set the new one. Don't use this mode= feature to keep files
                # private: use the buildworker's umask for that instead. (it
