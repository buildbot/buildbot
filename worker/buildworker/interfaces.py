...
class IWorkerCommand(Interface):
    ...
    """This interface is implemented by all of the buildworker's Command
    subclasses. It specifies how the buildworker can start, interrupt, and
    ...
    def __init__(builder, stepId, args):
        ...
        buildbot.bot.WorkerBuilder instance, which will be used to send status
