...
from buildworker import monkeypatches
from buildworker.commands import base
from buildworker.commands import registry
...
class WorkerBuilderBase(service.Service):
    ...
    def stopCommand(self):
        ...
        output. This is used when the buildworker is shutting down or the
    ...
    def remote_shutdown(self):
        ...
        log.msg("NOTE: master is using deprecated workerbuilder.shutdown method")
        reactor.stop()
...
class BuildWorkerBase(service.MultiService):
    Bot = BotBase
    ...
    def startService(self):
        ...
        log.msg("Starting BuildWorker -- version: %s" % buildworker.version)
