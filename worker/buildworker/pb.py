...
from buildworker.base import BotBase
from buildworker.base import BuildWorkerBase
from buildworker.base import WorkerBuilderBase
from buildworker.pbutil import ReconnectingPBClientFactory
...
class WorkerBuilderPb(WorkerBuilderBase, pb.Referenceable):
    pass
...
class BuildWorker(BuildWorkerBase, service.MultiService):
    Bot = BotPb
    ...
    def __init__(self, buildmaster_host, port, name, passwd, basedir,
        ...
        BuildWorkerBase.__init__(self, name, basedir, usePTY, umask=umask, unicode_encoding=unicode_encoding)
        if keepalive == 0:
            keepalive = None
