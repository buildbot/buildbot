...
class IsBuildworkerDirMixin(object):

    """
    Mixin for setting up mocked base.isBuildworkerDir() function
    """

    def setupUpIsBuildworkerDir(self, return_value):
        self.isBuildworkerDir = mock.Mock(return_value=return_value)
        self.patch(base, "isBuildworkerDir", self.isBuildworkerDir)
