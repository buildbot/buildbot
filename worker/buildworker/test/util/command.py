...
import buildworker.runprocess

from buildworker.commands import utils
from buildworker.test.fake import runprocess
from buildworker.test.fake import workerbuilder
...
class CommandTestMixin(object):
    ...
    def make_command(self, cmdclass, args, makedirs=False):
        ...
        This always creates the WorkerBuilder with a basedir (self.basedir).  If
        ...
        attributes are set:
            ...
            self.builder -- the (fake) WorkerBuilder
        """
        ...
        b = self.builder = workerbuilder.FakeWorkerBuilder(basedir=self.basedir)
    ...
    def patch_runprocess(self, *expectations):
        ...
        """
        self.patch(buildworker.runprocess, 'RunProcess', runprocess.FakeRunProcess)
        buildworker.runprocess.RunProcess.expect(*expectations)
