...
from buildworker.scripts import runner
...
class TestMakerBase(BaseDirTestsMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.runner.MakerBase class.
    """
...
class TestStopOptions(BaseDirTestsMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.runner.StopOptions class.
    """
    options_class = runner.StopOptions

    def test_synopsis(self):
        opts = runner.StopOptions()
        self.assertIn('buildworker stop', opts.getSynopsis())


class TestStartOptions(OptionsMixin, BaseDirTestsMixin, unittest.TestCase):

    """
    Test buildworker.scripts.runner.StartOptions class.
    """
    options_class = runner.StartOptions

    def test_synopsis(self):
        opts = runner.StartOptions()
        self.assertIn('buildworker start', opts.getSynopsis())
...
class TestRestartOptions(OptionsMixin, BaseDirTestsMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.runner.RestartOptions class.
    """
    options_class = runner.RestartOptions

    def test_synopsis(self):
        opts = runner.RestartOptions()
        self.assertIn('buildworker restart', opts.getSynopsis())
...
class TestUpgradeWorkerOptions(BaseDirTestsMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.runner.UpgradeWorkerOptions class.
    """
    options_class = runner.UpgradeWorkerOptions

    def test_synopsis(self):
        opts = runner.UpgradeWorkerOptions()
        self.assertIn('buildworker upgrade-worker', opts.getSynopsis())


class TestCreateWorkerOptions(OptionsMixin, unittest.TestCase):

    """
    Test buildworker.scripts.runner.CreateWorkerOptions class.
    """
    ...
    def test_synopsis(self):
        opts = runner.CreateWorkerOptions()
        self.assertIn('buildworker create-worker', opts.getSynopsis())
...
class TestOptions(misc.LoggingMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.runner.Options class.
    """
    ...
    def test_version(self):
        ...
        self.assertLogged('Buildworker version:')
...
class TestRun(misc.LoggingMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.runner.run()
    """
    ...
    def test_run_good(self):
        """
        Test successful invocation of buildworker command.
        """
