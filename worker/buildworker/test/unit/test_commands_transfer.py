...
from buildworker.commands import transfer
from buildworker.test.fake.remote import FakeRemote
from buildworker.test.util.command import CommandTestMixin
...
class TestWorkerDirectoryUpload(CommandTestMixin, unittest.TestCase):
    ...
    # this is just a subclass of WorkerUpload, so the remaining permutations
    # are already tested
