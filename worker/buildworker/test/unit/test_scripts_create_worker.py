...
from buildworker.scripts import create_worker
...
class TestMakeBaseDir(misc.LoggingMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.create_worker._makeBaseDir()
    """
...
class TestMakeBuildbotTac(misc.LoggingMixin,
    ...
    """
    Test buildworker.scripts.create_worker._makeBuildbotTac()
    """
...
class TestMakeInfoFiles(misc.LoggingMixin,
    ...
    """
    Test buildworker.scripts.create_worker._makeInfoFiles()
    """
...
class TestCreateWorker(misc.LoggingMixin, unittest.TestCase):
    ...
    """
    Test buildworker.scripts.create_worker.createWorker()
    """
    ...
    def assertTACFileContents(self, options):
        ...
        # mock BuildWorker class
        buildworker_mock = mock.Mock()
        buildworker_class_mock = mock.Mock(return_value=buildworker_mock)
        self.patch(buildworker.bot, "BuildWorker", buildworker_class_mock)
        ...
        application_class_mock.assert_called_once_with("buildworker")

        # check that BuildWorker created with passed options
        buildworker_class_mock.assert_called_once_with(
            options["host"],
            options["port"],
            options["name"],
            options["passwd"],
        ...
        # check that BuildWorker instance attached to application
        self.assertEqual(buildworker_mock.method_calls,
