...
from buildworker import base
from buildworker import pb
from buildworker.test.fake.remote import FakeRemote
from buildworker.test.fake.runprocess import Expect
from buildworker.test.util import command
...
# note that the BuildWorker class is tested in test_bot_BuildWorker
