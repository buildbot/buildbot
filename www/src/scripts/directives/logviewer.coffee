...
angular.module('app').directive 'logviewer',
['$log', '$window', 'buildbotService', "$timeout", "$sce", ($log, $window, buildbotService, $timeout, $sce) ->
    ...
    restrict: 'E'
    scope: {logid:"="}
    templateUrl: "views/directives/logviewer.html"
    link: (scope, elm, attr) ->
        self = directive()
