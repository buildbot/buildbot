       ...
       function(declare, _Widget, _TemplatedMixin, _WidgetsInTemplateMixin, Deferred, xhr,
           ...
           return declare([_Widget, _TemplatedMixin, _WidgetsInTemplateMixin], {
               ...
               createGrid: function(options, node) {
                   var self = this;
                   if (datastore[options.apiPath]){
                       options.store = datastore[options.apiPath];
               ...
               createBaseGrid: function(options, node) {
                   ...
                   */
                   ...
                   require ([
                       ...
                       "bb/ui/dgridext/AutoHeight","bb/ui/dgridext/StyledColumns",
                       "bb/ui/dgridext/TypedColumns",
                       "dojo/_base/array"
