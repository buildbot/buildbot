...
setup_www_plugin(
    name='buildbot-console-view-modified',
    description='Buildbot Console View Modified plugin.',
    author=u'Pierre Tardy',
    author_email=u'tardyp@gmail.com',
    url='http://buildbot.net/',
    license='GNU GPL',
    packages=['buildbot_console_view_modified'],
    package_data={
        '': [
            'VERSION',
            'static/*'
    ...
    entry_points="""
        [buildbot.www]
        console_view_modified = buildbot_console_view_modified:ep
    """,
)
