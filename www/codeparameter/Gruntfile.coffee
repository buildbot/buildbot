...
module.exports = (grunt) ->
    ...
    grunt.initConfig
        ...
        copy:
            ...
            # Copies ace files to the buildbot_www directory
            ace:
                files: [
                    cwd: 'bower_components/ace-builds/src-min/'
                    src: '*.js'
                    dest: 'buildbot_www/ace/'
                    expand: true
                ]
        ...
        html2js:
            views:
                files: [
                    ...
                    dest: "./.temp/#{plugin_name}/scripts/views.js"
                ]
                options:
                    module: "#{plugin_name}-templates-views"
                    base: './.temp/'
