...
export const ChangeDetails = observer(
  ({change, compact, showDetails, setShowDetails}: ChangeDetailsProps) => {
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                {showProps ? (
                  <pre className="changedetails-properties">
                    {JSON.stringify(change.properties)}
                  </pre>
                ) : (
                  <></>
                )}
