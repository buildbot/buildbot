...
describe('AnsiEscapeCodes', () => {
  ...
  describe('parseEscapeCodesToClasses', () => {
    ...
    it('with empty reset code', () => {
      // code sequence from protractor
      const ret = parseEscapeCodesToSimple(
        '\x1b[32m.\x1b[m\x1b[31mF\x1b[m\x1b[32m.\x1b[39m\x1b[32m.\x1b[m',
      );
      expect(ret).toEqual([
        {class: 'ansi32', text: '.'},
        {class: 'ansi31', text: 'F'},
    ...
    it('SGRbg SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[43mTEXT2 \x1b[0m');
      expect(ret).toEqual([
    ...
    it('SGRbg SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[31mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42', text: 'TEXT1 '},
    ...
    it('SGRbg SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[43;31mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42', text: 'TEXT1 '},
    ...
    it('SGRbg 256bg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[48;5;34mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42', text: 'TEXT1 '},
    ...
    it('SGRbg 256fg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42', text: 'TEXT1 '},
    ...
    it('SGRbg 256both', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[48;5;164;38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42', text: 'TEXT1 '},
    ...
    it('SGRbg reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('SGRbg resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('SGRfg SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[42mTEXT2 \x1b[0m');
      expect(ret).toEqual([
    ...
    it('SGRfg SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi31', text: 'TEXT1 '},
    ...
    it('SGRfg SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[42;32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi31', text: 'TEXT1 '},
    ...
    it('SGRfg 256bg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[48;5;34mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi31', text: 'TEXT1 '},
    ...
    it('SGRfg 256fg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi31', text: 'TEXT1 '},
    ...
    it('SGRfg 256both', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[48;5;164;38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi31', text: 'TEXT1 '},
        {class: 'ansibg-164 ansifg-226', text: 'TEXT2 '},
      ]);
    ...
    it('SGRfg reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi31', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('SGRfg resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[31mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi31', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('SGRboth SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[43mTEXT2 \x1b[0m');
      expect(ret).toEqual([
    ...
    it('SGRboth SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42 ansi31', text: 'TEXT1 '},
    ...
    it('SGRboth SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[43;32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42 ansi31', text: 'TEXT1 '},
    ...
    it('SGRboth 256bg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[48;5;34mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42 ansi31', text: 'TEXT1 '},
        {class: 'ansibg-34 ansi31', text: 'TEXT2 '},
      ]);
    ...
    it('SGRboth 256fg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42 ansi31', text: 'TEXT1 '},
        {class: 'ansifg-226 ansi42', text: 'TEXT2 '},
      ]);
    ...
    it('SGRboth 256both', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[48;5;164;38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42 ansi31', text: 'TEXT1 '},
        {class: 'ansibg-164 ansifg-226', text: 'TEXT2 '},
      ]);
    ...
    it('SGRboth reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42 ansi31', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('SGRboth resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[42;31mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansi42 ansi31', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('256bg SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34mTEXT1 \x1b[43mTEXT2 \x1b[0m');
      expect(ret).toEqual([
    ...
    it('256bg SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34mTEXT1 \x1b[32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34', text: 'TEXT1 '},
    ...
    it('256bg SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34mTEXT1 \x1b[43;32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34', text: 'TEXT1 '},
        {class: 'ansi43 ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('256bg 256bg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34mTEXT1 \x1b[48;5;36mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34', text: 'TEXT1 '},
    ...
    it('256bg 256fg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34mTEXT1 \x1b[38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34', text: 'TEXT1 '},
    ...
    it('256bg reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('256bg resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('256fg SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[38;5;196mTEXT1 \x1b[43mTEXT2 \x1b[0m');
      expect(ret).toEqual([
    ...
    it('256fg SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[38;5;196mTEXT1 \x1b[32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansifg-196', text: 'TEXT1 '},
        {class: 'ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('256fg SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[38;5;196mTEXT1 \x1b[43;32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansifg-196', text: 'TEXT1 '},
        {class: 'ansi43 ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('256fg 256bg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[38;5;196mTEXT1 \x1b[48;5;36mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansifg-196', text: 'TEXT1 '},
    ...
    it('256fg 256fg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[38;5;196mTEXT1 \x1b[38;5;226mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansifg-196', text: 'TEXT1 '},
        {class: 'ansifg-226', text: 'TEXT2 '},
      ]);
    ...
    it('256fg reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[38;5;196mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansifg-196', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('256fg resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[38;5;196mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansifg-196', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('256both SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34;38;5;226mTEXT1 \x1b[43mTEXT2 \x1b[0m');
      expect(ret).toEqual([
    ...
    it('256both SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34;38;5;226mTEXT1 \x1b[32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34 ansifg-226', text: 'TEXT1 '},
        {class: 'ansi32 ansibg-34', text: 'TEXT2 '},
      ]);
    ...
    it('256both SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34;38;5;226mTEXT1 \x1b[43;32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34 ansifg-226', text: 'TEXT1 '},
        {class: 'ansi43 ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('256both reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34;38;5;226mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34 ansifg-226', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('256both resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[48;5;34;38;5;226mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: 'ansibg-34 ansifg-226', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[43mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansi43', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[43;32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansi43 ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m 256bg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[48;5;36mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansibg-36', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m 256fg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[38;5;228mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
    ...
    it('reset0m 256both', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[48;5;164;38;5;228mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansibg-164 ansifg-228', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('resetm SGRbg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[43mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansi43', text: 'TEXT2 '},
      ]);
    ...
    it('resetm SGRfg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('resetm SGRboth', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[43;32mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansi43 ansi32', text: 'TEXT2 '},
      ]);
    ...
    it('resetm 256bg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[48;5;36mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansibg-36', text: 'TEXT2 '},
      ]);
    ...
    it('resetm 256fg', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[38;5;228mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansifg-228', text: 'TEXT2 '},
      ]);
    ...
    it('resetm 256both', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[48;5;164;38;5;228mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: 'ansibg-164 ansifg-228', text: 'TEXT2 '},
      ]);
    ...
    it('resetm reset0m', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[0mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('resetm resetm', () => {
      const ret = parseEscapeCodesToSimple('\x1b[mTEXT1 \x1b[mTEXT2 \x1b[0m');
      expect(ret).toEqual([
        {class: '', text: 'TEXT1 '},
        {class: '', text: 'TEXT2 '},
      ]);
    ...
    it('reset0m reset0m no text no spaces', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0m\x1b[0m\x1b[0m');
      expect(ret).toEqual([]);
    });

    it('reset0m resetm no text no spaces', () => {
      const ret = parseEscapeCodesToSimple('\x1b[0m\x1b[m\x1b[0m');
      expect(ret).toEqual([]);
    });

    it('resetm reset0m no text no spaces', () => {
      const ret = parseEscapeCodesToSimple('\x1b[m\x1b[0m\x1b[0m');
      expect(ret).toEqual([]);
    });

    it('resetm resetm no text no spaces', () => {
      const ret = parseEscapeCodesToSimple('\x1b[m\x1b[m\x1b[0m');
      expect(ret).toEqual([]);
    });
    ...
    it('unsupported modes', () => {
      ...
      expect(ret).toEqual([{class: '', text: 'PhantomJS 1.9.8 (Linux 0.0.0)'}]);
    });
  });
