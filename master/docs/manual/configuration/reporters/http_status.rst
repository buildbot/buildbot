...
.. py:class:: HttpStatusPush(serverUrl, user=None, password=None, auth=None, headers=None, format_fn=None, builders=None, wantProperties=False, wantSteps=False, wantPreviousBuild=False, wantLogs=False, debug=None, verify=None)
