...
Support for old-style steps has been dropped in Buildbot-3.0.
...
* :bb:step:`ShellCommand` subclasses implicitly gather all stdio output in memory and provide it to the ``createSummary`` method.
