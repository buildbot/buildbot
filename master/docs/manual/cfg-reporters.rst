...
Json object spec
----------------
The default json object sent is as follow.
...
.. code-block:: json

    {
        ...
        "build": {
            ...
            "buildset": "<buildset data api value>",
            "buildrequest": "<buildset data api value>"
        }
    }
...
It uses txrequests to make REST requests to the stash server.
