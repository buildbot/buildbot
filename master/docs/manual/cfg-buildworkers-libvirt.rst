...
This document will guide you through setup of a libvirt latent buildworker:
...
::
    ...
    from buildbot.plugins import buildworker, util
    c['workers'] = [
        buildworker.LibVirtWorker('minion1', 'sekrit',
