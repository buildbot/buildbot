...
* `Vite <https://vitejs.dev/>`_ build system, which provides fast builds and hot module replacement during development.
...
* `JSX <https://react.dev/learn/javascript-in-jsx-with-curly-braces>`_ syntax for combining JavaScript and HTML
