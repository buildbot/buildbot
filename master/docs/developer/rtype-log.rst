...
.. bb:rtype:: log
    ...
    :attr name: the name of this log (e.g., ``stdio``)
    ...
    .. bb:rpath:: /step/:stepid/log/:log_name
    ...
    .. bb:rpath:: /build/:buildid/step/:step_name/log/:log_name
    ...
    .. bb:rpath:: /builder/:builderid/build/:build_number/step/:name/log/:log_name
