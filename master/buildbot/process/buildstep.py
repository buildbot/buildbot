...
class ShellBaseStep(BuildStep):
    ...
    def setupLogsRunCommandAndProcessResults(
        self, cmd, stdioLog=None, closeLogWhenFinished=True,
        ...
        log.msg("%s.setupLogsRunCommandAndProcessResults(cmd=%s)" %
