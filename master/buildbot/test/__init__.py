...
if parse_version(mock.__version__) < parse_version("0.8"):
    raise ImportError(
        "\nBuildbot tests require mock version 0.8.0 or " "higher; try 'pip install -U mock'"
    )
...
warnings.filterwarnings(
    "ignore",
    r".*Use 'list\(elem\)' or iteration over elem instead.*",
    DeprecationWarning,
)
warnings.filterwarnings(
...
warnings.filterwarnings(
    "ignore",
    ".*Not importing directory .*/zope: missing __init__",
    category=ImportWarning,
)
warnings.filterwarnings(
    "ignore",
    ".*Not importing directory .*/sphinxcontrib: missing __init__",
    category=ImportWarning,
)
...
warnings.filterwarnings(
    "ignore",
    ".*The loop argument is deprecated since Python",
...
warnings.filterwarnings(
    "ignore",
    ".*stream argument is deprecated. Use stream parameter",
    category=DeprecationWarning,
)
