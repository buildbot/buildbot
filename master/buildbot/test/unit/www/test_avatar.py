...
class AvatarResource(TestReactorMixin, www.WwwTestMixin, unittest.TestCase):
    ...
    def test_default(self):
        ...
        self.assertEqual(res, dict(redirected=avatar.AvatarResource.defaultAvatarUrl))
...
class GitHubAvatar(TestReactorMixin, www.WwwTestMixin, unittest.TestCase):
    ...
    def test_username(self):
        ...
        self.assertEqual(
            res,
            dict(redirected=b"https://avatars3.githubusercontent.com/" b"u/42424242?v=4&s=32"),
        )
...
class GitHubAvatarBasicAuth(TestReactorMixin, www.WwwTestMixin, unittest.TestCase):
    ...
    def test_username(self):
        ...
        self.assertEqual(
            res,
            {"redirected": b"https://avatars3.githubusercontent.com/" b"u/42424242?v=4&s=32"},
        )
