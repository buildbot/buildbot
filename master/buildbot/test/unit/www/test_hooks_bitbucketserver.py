...
class TestChangeHookConfiguredWithGitChange(unittest.TestCase, TestReactorMixin):
    ...
    def _checkPush(self, change):
        ...
        self.assertEqual(
            change['comments'],
            'Bitbucket Server commit 793d4754230023d85532f9a38dba3290f959beb4',
        )
        self.assertEqual(
            change['revlink'],
    ...
    async def testHookWithChangeOnRefsChangedEvent(self):
    ...
    async def testHookWithCodebaseValueOnPushEvent(self):
        ...
        await self._checkCodebase('repo:refs_changed', 'super-codebase')
    ...
    async def testHookWithCodebaseFunctionOnPushEvent(self):
        ...
        await self._checkCodebase('repo:refs_changed', 'CI')
