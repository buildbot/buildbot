...
class Tests(interfaces.InterfaceTests):
    ...
    def test_updateBuilderInfo(self):
        ...
        yield self.db.builders.updateBuilderInfo(
            7, "a string which describe the builder", ["cat1", "cat2"]
        )
    ...
    def test_findBuilderId_new(self):
        ...
        self.assertEqual(
            builderdict,
            dict(id=id, name="some:builder", tags=[], masterids=[], description=None),
        )
    ...
    def test_addBuilderMaster(self):
        ...
        self.assertEqual(
            builderdict,
            dict(id=7, name="some:builder", tags=[], masterids=[9, 10], description=None),
        )
    ...
    def test_addBuilderMaster_already_present(self):
        ...
        self.assertEqual(
            builderdict,
            dict(id=7, name="some:builder", tags=[], masterids=[9], description=None),
        )
    ...
    def test_removeBuilderMaster(self):
        ...
        self.assertEqual(
            builderdict,
            dict(id=7, name="some:builder", tags=[], masterids=[10], description=None),
        )
    ...
    def test_getBuilder_no_masters(self):
        ...
        self.assertEqual(
            builderdict,
            dict(id=7, name="some:builder", tags=[], masterids=[], description=None),
        )
    ...
    def test_getBuilder_with_masters(self):
        ...
        self.assertEqual(
            builderdict,
            dict(id=7, name="some:builder", tags=[], masterids=[3, 4], description=None),
        )
