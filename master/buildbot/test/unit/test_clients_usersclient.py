...
class TestUsersClient(unittest.TestCase):
    ...
    def _fake_callRemote(self, method, op, bb_username, bb_password, ids, info):
        ...
        self.called_with = dict(
            op=op, bb_username=bb_username, bb_password=bb_password, ids=ids, info=info
        )
    ...
    def test_usersclient_ids(self):
        ...
        self.assertProcess(
            "localhost",
            1234,
            dict(op="remove", bb_username=None, bb_password=None, ids=["x"], info=None),
        )
