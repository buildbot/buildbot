...
_FAKE_ENTRIES = {
    "buildbot.interface": [
        FakeEntry("good", "non-existent", "irrelevant", False, ClassWithInterface),
        FakeEntry("deep.path", "non-existent", "irrelevant", False, ClassWithInterface),
    ],
    ...
    "buildbot.interface_failed": [
        FakeEntry("good", "non-existent", "irrelevant", True, ClassWithInterface)
    ],
    "buildbot.no_interface": [
        FakeEntry("good", "non-existent", "irrelevant", False, ClassWithNoInterface)
    ],
    "buildbot.no_interface_again": [
        FakeEntry("good", "non-existent", "irrelevant", False, ClassWithNoInterface)
    ],
    "buildbot.no_interface_failed": [
        FakeEntry("good", "non-existent", "irrelevant", True, ClassWithNoInterface)
    ],
    "buildbot.duplicates": [
        FakeEntry("good", "non-existent", "first", False, ClassWithNoInterface),
        FakeEntry("good", "non-existent", "second", False, ClassWithNoInterface),
    ],
}
