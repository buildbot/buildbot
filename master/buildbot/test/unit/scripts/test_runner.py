...
class OptionsMixin:
    ...
    def assertOptions(self, opts: dict[Any, Any], exp: dict[Any, Any]) -> None:
        assert isinstance(self, unittest.TestCase)
        got = {k: opts[k] for k in exp}
        if got != exp:
            msg = []
            for k, v in exp.values():
                if opts[k] != v:
...
class TestUpgradeMasterOptions(OptionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.UpgradeMasterOptions:
...
class TestCreateMasterOptions(OptionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.CreateMasterOptions:
...
class BaseTestSimpleOptions(OptionsMixin):
    ...
    optionsClass: type[usage.Options]

    def setUp(self) -> None:
        self.setUpOptions()

    def parse(self, *args: Any) -> usage.Options:
...
class TestTryOptions(OptionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.TryOptions:
...
class TestSendChangeOptions(OptionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.SendChangeOptions:
...
class TestTryServerOptions(OptionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.TryServerOptions:
...
class TestCheckConfigOptions(OptionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.CheckConfigOptions:
...
class TestUserOptions(OptionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.UserOptions:
...
class TestOptions(OptionsMixin, misc.StdoutAssertionsMixin, unittest.TestCase):
    ...
    def parse(self, *args: Any) -> runner.Options:
...
class TestRun(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        subcommandFunction = mock.Mock(name='subcommandFunction', return_value=3)  # type: ignore[name-defined]
