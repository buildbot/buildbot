    ...
    @parameterized.expand(
        [
            ...
            (
                "nothing",
                "builder1",
                {"project": "value_other", "repository": "value_other"},
                False,
            ),
            (
                "single1",
                "builder1",
                {"project": "p", "repository": "value_other"},
                True,
            ),
            (
                "single2",
                "builder1",
                {"project": "value_other", "repository": "r"},
                True,
            ),
...
class TestOldBuildTracker(unittest.TestCase):
    ...
    def test_cancel_multi_codebase_build_ignores_non_matching_change_in_tracked_build(
        self,
    ):
        ss_dict1 = self.create_ss_dict("pr1", "cb1", "rp1", "br1")
...
class TestOldBuildCancellerUtils(ConfigErrorsMixin, unittest.TestCase):
    @parameterized.expand(
        [
            ...
            (
                "with_repository",
                [(["bldr"], SourceStampFilter(repository_eq=["value"]))],
            ),
