...
class TestForceScheduler(
    ...
    def test_PatchParameter(self):
        ...
        self.do_ParameterTest(
            req=dict(p1_author="me", reason="because"),
            expect={
                "author": "me",
                "body": "",
                "comment": "",
    ...
    def test_NestedParameter(self):
        ...
        self.do_ParameterTest(
            req=dict(p1_foo="123", reason="because"),
            expect=dict(foo=123),
    ...
    def test_NestedNestedParameter(self):
        fields = [
            NestedParameter(
                name="inner",
                fields=[StringParameter(name="str"), AnyPropertyParameter(name="any")],
            ),
    ...
    def test_NestedParameter_nullname(self):
        ...
        fields = [
            NestedParameter(
                name="inner",
                fields=[StringParameter(name="str"), AnyPropertyParameter(name="")],
            ),
            IntParameter(name="foo"),
            NestedParameter(
                name="bar",
        ...
        self.do_ParameterTest(
            ...
            expect=dict(foo=123, inner=dict(str="bar", hello="world"), bar={"a": "7", "b": "8"}),
            expectKind=dict,
            klass=NestedParameter,
            fields=fields,
            name="",
    ...
    def test_listofints_builderNames(self):
        with self.assertRaisesConfigError(
            ...
            ForceScheduler(
                name="testsched", builderNames=[1234], codebases=["bar"], username="foo"
            )
