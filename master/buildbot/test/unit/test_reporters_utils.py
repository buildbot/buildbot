...
class TestDataUtils(unittest.TestCase):
    ...
    def setupDb(self):
        ...
        self.db.insertTestData([
            ...
            fakedb.Build(id=18, number=0, builderid=80, buildrequestid=9, buildworkerid=13,
                         masterid=92, results=FAILURE),
            fakedb.Build(id=19, number=1, builderid=80, buildrequestid=10, buildworkerid=13,
                         masterid=92, results=RETRY),
            fakedb.Build(id=20, number=2, builderid=80, buildrequestid=11, buildworkerid=13,
                         masterid=92, results=SUCCESS),
            fakedb.Build(id=21, number=3, builderid=80, buildrequestid=12, buildworkerid=13,
                         masterid=92, results=SUCCESS),
