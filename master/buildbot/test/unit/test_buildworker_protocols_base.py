...
class TestFakeConnection(protocols.ConnectionInterfaceTest, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.conn = fakeprotocol.FakeConnection(self.master, self.buildworker)
...
class TestConnection(protocols.ConnectionInterfaceTest, unittest.TestCase):
    ...
    def setUp(self):
        self.master = fakemaster.make_master()
        self.buildworker = mock.Mock()
        self.conn = base.Connection(self.master, self.buildworker)

    def test_constructor(self):
        self.assertEqual(self.conn.master, self.master)
        self.assertEqual(self.conn.buildworker, self.buildworker)
