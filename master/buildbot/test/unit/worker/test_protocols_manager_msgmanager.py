...
class TestBuildbotWebSocketServerProtocol(unittest.TestCase):
    ...
    @parameterized.expand(
        [
            ...
            (
                "update_upload_directory_unpack_seq_number",
                {"op": "update_upload_directory_unpack"},
            ),
            ("update_upload_directory_write_op", {"seq_number": 1}),
            (
                "update_upload_directory_write_seq_number",
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                {"op": "update_upload_file_write", "args": "args"},
            ),
            (
            ...
            (
                "upload_directory_write",
                {"op": "update_upload_directory_write", "args": "args"},
            ),
        ]
    )
    @defer.inlineCallbacks
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                {"op": "update_upload_file_close", "command_id": 2},
            ),
            (
                "update_upload_file_utime",
                {
    ...
    @parameterized.expand(
        [
            ...
            (
                "update_upload_file_write",
                {"op": "update_upload_file_write", "command_id": 2},
            ),
            (
                "update_upload_directory_write",
                {"op": "update_upload_directory_write", "command_id": 1},
            ),
        ]
    )
    @defer.inlineCallbacks
    ...
    @parameterized.expand(
        [
            (
                "update_read_file",
                {"op": "update_read_file", "length": 1, "command_id": 2},
            ),
            (
                "update_read_file_close",
                {"op": "update_read_file_close", "command_id": 2},
            ),
        ]
    )
    @defer.inlineCallbacks
    ...
    def test_complete_check_dict_removal(self):
        ...
        self.protocol.command_id_to_reader_map = {
            command_id: "test_reader",
            2: "test_reader2",
        }
        self.protocol.command_id_to_writer_map = {
            command_id: "test_writer",
            2: "test_writer2",
        }
