...
class TestDockerLatentWorker(unittest.TestCase, TestReactorMixin):
    ...
    def test_start_instance_volume_renderable(self):
        ...
        self.assertEqual(
            client.call_args_create_container[0]["volumes"],
    ...
    def test_volume_no_suffix(self):
        ...
        self.assertEqual(client.call_args_create_container[0]["volumes"], ["/opt/webapp"])
        self.assertEqual(
            client.call_args_create_host_config[0]["binds"], ["/src/webapp:/opt/webapp"]
        )
    ...
    def test_volume_ro_rw(self):
        ...
        self.assertEqual(len(client.call_args_create_host_config), 1)
        self.assertEqual(
            client.call_args_create_container[0]["volumes"], ["/opt/webapp", "/backup"]
        )
        self.assertEqual(
            client.call_args_create_host_config[0]["binds"],
