...
class TestMessage(unittest.TestCase):
    ...
    def setupDb(self, results1, results2):
        ...
        self.db.insertTestData([
            ...
            fakedb.Build(id=20, number=0, builderid=80, buildrequestid=11, buildworkerid=13,
                         masterid=92, results=results1),
            fakedb.Build(id=21, number=1, builderid=80, buildrequestid=12, buildworkerid=13,
                         masterid=92, results=results1),
        ])
        for _id in (20, 21):
            self.db.insertTestData([
