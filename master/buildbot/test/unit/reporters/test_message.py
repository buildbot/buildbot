...
class TestMessageFormatting(unittest.TestCase):
    ...
    def test_get_message_summary_text_warnings(self):
        ...
        self.assertEqual(
            message.get_message_summary_text({"state_string": None}, WARNINGS),
            "Build Had Warnings",
        )
    ...
    def test_get_message_summary_text_skipped(self):
        ...
        self.assertEqual(
            message.get_message_summary_text({"state_string": None}, SKIPPED),
            "BUILD FAILED",
        )
...
class TestMessageFormatter(MessageFormatterTestBase):
    ...
    def test_message_failure_change(self):
        ...
        self.assertIn(
            "A new failure has been detected on builder Builder1 while building",
            res["body"],
        )
    ...
    def test_message_success_change(self):
        ...
        self.assertIn(
            "A restored build has been detected on builder Builder1 while building",
            res["body"],
        )
