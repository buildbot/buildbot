...
class Matcher(unittest.TestCase):
    ...
    def test_pattern_variables(self):
        self.m[("A", ":a", "B", ":b")] = "AB"
        self.assertEqual(self.m[("A", "a", "B", "b")], ("AB", dict(a="a", b="b")))

    def test_pattern_variables_underscore(self):
        self.m[("A", ":a_a_a")] = "AB"
        self.assertEqual(self.m[("A", "a")], ("AB", dict(a_a_a="a")))

    def test_pattern_variables_num(self):
        self.m[("A", "n:a", "B", "n:b")] = "AB"
        self.assertEqual(self.m[("A", "10", "B", "-20")], ("AB", dict(a=10, b=-20)))

    def test_pattern_variables_ident(self):
        self.m[("A", "i:a", "B", "i:b")] = "AB"
        self.assertEqual(self.m[("A", "abc", "B", "x-z-B")], ("AB", dict(a="abc", b="x-z-B")))
