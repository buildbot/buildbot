...
class TestSourceStampFilter(unittest.TestCase):
    ...
    def test_extract_filter_values_regex(self):
        ...
        self.assertEqual(extract_filter_values_regex("value", "name"), ["value"])
        self.assertEqual(
            extract_filter_values_regex([re.compile("test")], "name"),
            [re.compile("test")],
        )
        self.assertEqual(
            extract_filter_values_regex(re.compile("test"), "name"),
    ...
    @parameterized.expand(
        [
            (
                "match",
                {"project": "p", "codebase": "c", "repository": "r", "branch": "b"},
                True,
            ),
            (
                "not_project",
                {"project": "0", "codebase": "c", "repository": "r", "branch": "b"},
                False,
            ),
            (
                "not_codebase",
                {"project": "p", "codebase": "0", "repository": "r", "branch": "b"},
                False,
            ),
            (
                "not_repository",
                {"project": "p", "codebase": "c", "repository": "0", "branch": "b"},
                False,
            ),
            (
                "not_branch",
                {"project": "p", "codebase": "c", "repository": "r", "branch": "0"},
                False,
            ),
            (
                "none_branch",
                {"project": "p", "codebase": "c", "repository": "r", "branch": None},
                False,
            ),
        ]
    )
    def test_filter_is_matched_eq_or_re(self, name, ss, expected):
        ...
        filter = SourceStampFilter(
            project_re="^p$", codebase_re="^c$", repository_re="^r$", branch_re="^b$"
        )
        self.assertEqual(filter.is_matched(ss), expected)
    ...
    @parameterized.expand(
        [
            ...
            (
                "not_project",
                {"project": "p0", "codebase": "c", "repository": "r", "branch": "b"},
                False,
            ),
            (
                "not_codebase",
                {"project": "p", "codebase": "c0", "repository": "r", "branch": "b"},
                False,
            ),
            (
                "not_repository",
                {"project": "p", "codebase": "c", "repository": "r0", "branch": "b"},
                False,
            ),
            (
                "not_branch",
                {"project": "p", "codebase": "c", "repository": "r", "branch": "b0"},
                False,
            ),
            (
                "none_branch",
