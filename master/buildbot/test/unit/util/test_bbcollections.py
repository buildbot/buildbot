...
class KeyedSets(unittest.TestCase):
    def setUp(self) -> None:
        self.ks: bbcollections.KeyedSets = bbcollections.KeyedSets()
    ...
    def test_discard_noError(self) -> None:
        self.ks.add('full', 12)
    ...
    def test_contains_setNamesNotContents(self) -> None:
        self.ks.add('yarn', 'red')
    ...
    def test_pop_missing(self) -> None:
