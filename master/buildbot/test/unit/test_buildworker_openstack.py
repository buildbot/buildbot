...
from buildbot.buildworker import openstack
from twisted.internet import defer
from twisted.trial import unittest


class TestOpenStackBuildWorker(unittest.TestCase):
    os_auth = dict(
        os_username='user',
        os_password='pass',
    ...
    def test_constructor_nonova(self):
        ...
        self.assertRaises(config.ConfigErrors,
                          openstack.OpenStackLatentBuildWorker, 'bot', 'pass',
                          **self.bs_image_args)

    def test_constructor_minimal(self):
        bs = openstack.OpenStackLatentBuildWorker('bot', 'pass', **self.bs_image_args)
    ...
    def test_constructor_block_devices_default(self):
        ...
        bs = openstack.OpenStackLatentBuildWorker('bot', 'pass', flavor=1,
    ...
    def test_start_instance_fail_to_find(self):
        ...
        self.assertRaises(interfaces.LatentBuildWorkerFailedToSubstantiate,
                          bs._start_instance)
    ...
    def test_start_instance_check_meta(self):
        ...
        bs = openstack.OpenStackLatentBuildWorker('bot', 'pass', meta=meta_arg,
                                                 **self.bs_image_args)
        bs._poll_resolution = 0
        uuid, image_uuid, time_waiting = bs._start_instance()
