...
class TestSetPropertiesFromEnv(steps.BuildStepMixin, unittest.TestCase):
    ...
    def test_simple(self):
        self.setupStep(worker.SetPropertiesFromEnv(
            ...
            source="me"))
        self.buildworker.worker_environ = {"one": "1", "two": None, "six": "6", "FIVE": "555"}
        self.buildworker.worker_system = 'linux'
    ...
    def test_case_folding(self):
        ...
        self.buildworker.worker_environ = {"ENV": 'EE'}
        self.buildworker.worker_system = 'win32'
        self.expectOutcome(result=SUCCESS,
                           state_string="Set")
...
class TestFileExists(steps.BuildStepMixin, unittest.TestCase):
    ...
    def test_old_version(self):
        ...
        yield self.runStep()
        self.flushLoggedErrors(BuildWorkerTooOldError)
