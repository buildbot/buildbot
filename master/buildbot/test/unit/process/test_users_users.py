...
class UsersTests(TestReactorMixin, unittest.TestCase):
    ...
    def test_createUserObject_git(self):
        ...
        self.assertEqual(
            ...
            {1: [dict(attr_type="git", attr_data="Tyler Durden <tyler@mayhem.net>")]},
        )
    ...
    def test_createUserObject_svn(self):
        ...
        self.assertEqual(
            self.db.users.users,
            {1: dict(identifier="tdurden", bb_username=None, bb_password=None)},
        )
        self.assertEqual(
    ...
    def test_createUserObject_hg(self):
        ...
        self.assertEqual(
            self.db.users.users_info,
            {1: [dict(attr_type="hg", attr_data="Tyler Durden <tyler@mayhem.net>")]},
        )
    ...
    def test_createUserObject_darcs(self):
        ...
        self.assertEqual(
            self.db.users.users,
            {1: dict(identifier="tyler@mayhem.net", bb_username=None, bb_password=None)},
        )
        self.assertEqual(
            self.db.users.users_info,
            {1: [dict(attr_type="darcs", attr_data="tyler@mayhem.net")]},
        )
    ...
    def test_createUserObject_bzr(self):
        ...
        self.assertEqual(
            self.db.users.users,
            {1: dict(identifier="Tyler Durden", bb_username=None, bb_password=None)},
        )
        self.assertEqual(
            self.db.users.users_info,
            {1: [dict(attr_type="bzr", attr_data="Tyler Durden")]},
        )
