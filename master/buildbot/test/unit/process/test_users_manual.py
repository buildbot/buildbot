...
class TestCommandlineUserManagerPerspective(TestReactorMixin, unittest.TestCase, ManualUsersMixin):
    ...
    def test_perspective_commandline_add(self):
        ...
        self.assertEqual(
            usdict,
            dict(uid=1, identifier="x", bb_username=None, bb_password=None, git="x"),
        )
    ...
    def test_perspective_commandline_update(self):
        ...
        self.assertEqual(
            usdict,
            dict(uid=1, identifier="x", bb_username=None, bb_password=None, svn="y"),
        )
    ...
    def test_perspective_commandline_get(self):
        ...
        self.assertEqual(
            res,
            dict(uid=1, identifier="x", bb_username=None, bb_password=None, svn="x"),
        )
