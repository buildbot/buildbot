...
"""
A LatentWorker that uses EC2 to instantiate the workers on demand.
...
from buildbot.buildworker.base import AbstractLatentBuildWorker
...
class EC2LatentBuildWorker(AbstractLatentBuildWorker):
