...
class Model(base.DBConnectorComponent):
    ...
    implied_indexes = [
        ...
        ("sourcestamps", dict(unique=False, column_names=["patchid"], name="patchid")),
        (
            "scheduler_masters",
        ...
        (
            "buildset_sourcestamps",
            dict(unique=False, column_names=["sourcestampid"], name="sourcestampid"),
        ),
        (
            "buildsets",
            dict(unique=False, column_names=["parent_buildid"], name="parent_buildid"),
        ),
        ("builders_tags", dict(unique=False, column_names=["tagid"], name="tagid")),
        (
            "changes",
            dict(unique=False, column_names=["parent_changeids"], name="parent_changeids"),
        ),
        (
            "test_result_sets",
            {
