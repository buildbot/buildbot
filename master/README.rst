...
* Buildbot has minimal requirements for build workers: using virtualenv, only a Python installation is required.
* Build workers can be run behind a NAT firewall and communicate with the master.
